...
class TestBasicFunctionality:
    ...
    async def test_oauth_tool_shows_options(self):
        ...
        result_tuple = await mcp.call_tool("get_oauth_access_token", {
            "method": "ask"
        })
        result = extract_result(result_tuple)
    ...
    async def test_project_discovery(self):
        ...
        result_tuple = await mcp.call_tool("project_discover", {
            "action": "agents",
            "search_path": "."
        })
        result = extract_result(result_tuple)
    ...
    async def test_credentials_list(self):
        ...
        result_tuple = await mcp.call_tool("manage_credentials", {
            "action": "list"
        })
        result = extract_result(result_tuple)
    ...
    async def test_memory_list(self):
        """Test memory listing"""
        try:
            result_tuple = await mcp.call_tool("agent_memory", {
                "action": "list",
                "agent_name": ""
            })
            result = extract_result(result_tuple)
...
class TestErrorHandling:
    ...
    async def test_nonexistent_file_analysis(self):
        ...
        result_tuple = await mcp.call_tool("analyze_agent_code", {
            "file_path": "definitely_does_not_exist_12345.py"
        })
        result = extract_result(result_tuple)
